...
class RoomType {
  ...
  final int capacityAdults, capacityChildren, pricePerNight, availableRooms;
  final List<RoomAmenity> amenities;
  final bool refundable, breakfastIncluded;
}
...
class Hotel {
  ...
  final String id, nameAr, cityAr, addressAr, descriptionAr;
  final Province province;
  final double rating;
  final int stars, reviewsCount, minimumPricePerNight;
  ...
  Hotel copyWith({bool? isFavorite}) => Hotel(
      id: id,
      nameAr: nameAr,
      province: province,
      cityAr: cityAr,
