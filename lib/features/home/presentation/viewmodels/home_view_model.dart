...
class HomeViewModel extends ChangeNotifier {
  ...
  List<Hotel> get featured =>
      hotels.where((item) => item.isFeatured).toList(growable: false);
  List<Hotel> get popular =>
      hotels.where((item) => item.isPopular).toList(growable: false);
  List<Hotel> get recommended =>
      hotels.where((item) => item.isRecommended).toList(growable: false);
  @override
  void dispose() {
